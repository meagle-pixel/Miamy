<?php
	...
	if(isset($_GET['list']) && $_GET['list']=='unread')
		$listMessages = $messagesunread;
	elseif(isset($_GET['list']) && $_GET['list']=='send')
		$listMessages = $messagessent;
	elseif(isset($_GET['list']) && $_GET['list']=='trash')
		$listMessages = $messagesdelete;
