<?php
	...
	{
		updateUserData($_SESSION['admin_user']['id']);
	}
							...
							<div class="dropdown-menu dropdown-menu-end">
								<a href="javascript:;">
									<div class="msg-header">
										<h6 class="msg-header-title">6 Nouveaux</h6>
						...
						<li class="nav-item dropdown dropdown-user-profile">
							<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
								<div class="d-flex user-box align-items-center">
									<div class="user-info">
										<p class="user-name mb-0"><?php echo $_SESSION['admin_user']['infos']['prenom'].' '.$_SESSION['admin_user']['infos']['nom']; ?></p>
										<p class="designattion mb-0">Disponible</p>
									</div>
									<img src="users/<?php echo $_SESSION['admin_user']['picture']; ?>" class="user-img" alt="Avatar <?php echo $_SESSION['admin_user']['infos']['prenom'].' '.$_SESSION['admin_user']['infos']['nom']; ?>">
								</div>
							</a>
							<div class="dropdown-menu dropdown-menu-end">	
								<a class="dropdown-item" href="index.php?mod=profil"><i
										class="bx bx-user"></i><span>Profil</span></a>
								<a class="dropdown-item" href="index.php?mod=parametres"><i
										class="bx bx-cog"></i><span>Paramètres</span></a>
								<a class="dropdown-item" href="index.php?mod=abonnements"><i
										class="bx bx-wallet"></i><span>Abonnements</span></a>
								<div class="dropdown-divider mb-0"></div>	<a class="dropdown-item" href="login.php"><i
						...
						<li class="nav-item dropdown dropdown-language d-none">
							<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-bs-toggle="dropdown">
								<div class="lang d-flex">
									<div><i class="flag-icon flag-icon-fr"></i></div>
								</div>
							</a>
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="index.php"><i class="flag-icon flag-icon-fr"></i><span>Français</span></a>
								<a class="dropdown-item" href="index.php"><i class="flag-icon flag-icon-um"></i><span>English</span></a>
							</div>
						</li>
					</ul>
				</div>
