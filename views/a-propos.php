   ...
   <!-- Common Banner Area -->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about_us_left">
                        <h5>About us</h5>
                        <h2>Why We are the best Since 2000</h2>
    ...
    <!-- About Service Area -->
    <section id="about_service_offer">
        <div class="container">
            <div class="row">
    ...
    <section class="section_padding_bottom">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="customer_review_slider owl-theme owl-carousel dot_style">
                        <div class="col-lg-12">
                            <div class="all_review_box">
                                ...
                                <div class="all_review_text">
                                    ...
                                    <p>“Eu ipsum ut dolore magna minim cupidatat ullamco anim sit minim irure.
                                        Consectetur
                                        voluptate nisi magna consectetur cillum proident dolore veniam voluptate
                                        adipisicing
                                        labore. Anim eiusmod dolor quis pariatur.”</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
