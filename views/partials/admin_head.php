...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= $GLOBALS['url'] ?>/assets/img/favicon-96x96.png">
    <!-- Datatables -->
...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand ps-3" href="<?= $GLOBALS['url'] ?>/accueil">Miamy Admin</a>
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="<?= $GLOBALS['url'] ?>/mon-compte">Mon compte</a></li>
                    <li>
                        <hr class="dropdown-divider" />
                    </li>
                    <li><a class="dropdown-item" href="<?= $GLOBALS['url'] ?>/deconnexion">Déconnexion</a></li>
                </ul>
            </li>
        </ul>
    </nav>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link <?= $current_mod === 'dashboard' ? 'active' : '' ?>" href="<?= $GLOBALS['url'] ?>/dashboard">
